...
import static org.yinwang.pysonar.ast.Node.resolveList;
...
public class FunctionDef extends Node {
    ...
    public List<Node> decorators; // Name nodes with builtin (eg. __builtin__.classmethod) binding
    ...
    public FunctionDef(Name name, List<Node> args, Node body, List<Node> defaults,
            List<Node> decorators, Name vararg, Name kwarg, String file, int start, int end) {
        ...
        Analyzer.self.ds.addFunctionDef(name, this);
    }
    ...
    public Type transform(@NotNull State s) {
        ...
        fun.setDecorators(decorators);
        resolveList(decorators, s); // create real nodes from decorators
...
//            // bind here
////            if (s.stateType == State.StateType.CLASS) {
////                funkind = Binding.Kind.METHOD; //should be lambda?
////            } else {
////                funkind = Binding.Kind.FUNCTION; //should be lambda?
////            }
////            Type outType = s.type;
////            if (outType instanceof ClassType) {
////                fun.setCls((ClassType) outType);
...
//    }
    ...
    public static String genLambdaName() {
        ...
        return "lambda_no" + lambdaCounter;
    }

    @NotNull
    @Override
    public String toString() {
        return "(func:" + getStart() + ":" + name + ")";
    }
