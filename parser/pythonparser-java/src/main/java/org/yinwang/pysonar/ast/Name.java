...
public class Name extends Node {
    ...
    public Name(@NotNull String id, String file, int start, int end) {
        ...
        Analyzer.self.ds.addName(idHash, this);
    }
    ...
    public Name(@NotNull String id, NameType type, String file, int start, int end,
        ...
        super(type, file, start, end, lineStart, offset, lineEnd, endOffset);
        this.id = id;
        this.name = id;
        this.type = type;
        this.setAstType("alias");
        Analyzer.self.ds.addName(idHash, this);
    }
     ...
     * the attribute being accessed) of an {@link Attribute} node.
     */
