...
from my_ast.built_in_types import Boolean, Complex, Dictionary, Float, FrozenSet, Integer, File, Range, Slice, Tuple, \
    Object, MemoryView, String, Bytes, ByteArray, Type
...
class BuiltInFunction(FunctionDeclaration, ABC):
    def __init__(self):
        ...
        qualified_name = "builtins." + self.get_name()
