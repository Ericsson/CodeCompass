...
```bash
sudo deb http://apt.llvm.org/bionic/ llvm-toolchain-bionic-7 main
sudo deb-src http://apt.llvm.org/bionic/ llvm-toolchain-bionic-7 main
...
0.12.0 version the Java jars are placed to the
