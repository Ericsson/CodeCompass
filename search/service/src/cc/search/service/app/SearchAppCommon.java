...
import cc.service.core.BasicFileInfo;
import cc.service.core.LineMatch;
import cc.service.core.Range;
import cc.service.core.SearchResultEntry;
import java.io.File;
...
public abstract class SearchAppCommon implements AutoCloseable {
  ...
  private class SearchResultMatcherTask implements Callable<SearchResultEntry> {
    ...
    public SearchResultEntry call() throws IOException {
      ...
      BasicFileInfo docsInfo = new BasicFileInfo(context.fileId,
        context.file.getName(), context.file.getPath());
      ...
      if (match.isEmpty()) {
        _log.log(Level.WARNING, "Empty match for {0} ({1})", 
          new Object[]{context.file.getPath(), context.fileId.fid});
        return null;
      }
