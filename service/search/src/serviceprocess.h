#ifndef __CODECOMPASS_SEARCH_SERVICE_SERVICE_PROCESS_H__
#define __CODECOMPASS_SEARCH_SERVICE_SERVICE_PROCESS_H__
...
#endif // __CODECOMPASS_SEARCH_SERVICE_SERVICE_PROCESS_H__
